package com.svennieke.AgeingMobs.compat.jei.biometype;
...
public class BiomeTypeWrapper implements IRecipeWrapper{
	...
	public BiomeTypeWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime, BiomeDictionary.Type biomeType) {
		this.entity = entity;
	...
	public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		 ...
		 if(originalEntity != null && agedEntity != null)
		 {
			 ...
			 String biomeTypeName = "Biome Type: " + capitalizeFirstLetter(biomeType.getName());
			 fontRenderer.drawString(biomeTypeName, 72 - (fontRenderer.getStringWidth(biomeTypeName)/2), 16, -1, true);
	...
	private String capitalizeFirstLetter(String string) 
	{
		...
		String s2 = string.substring(1, string.length()).toLowerCase();
		return s1 + s2;
	}
}
