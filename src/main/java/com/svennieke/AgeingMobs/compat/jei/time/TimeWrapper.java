...
public class TimeWrapper implements IRecipeWrapper{
	...
	public TimeWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime, int minTime, int maxTime) {
		this.entity = entity;
	...
	public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		 ...
		 if(originalEntity != null && agedEntity != null)
		 {
			 ...
			 String timeName = "Time: " + minTime + " to " + maxTime;
			 fontRenderer.drawString(timeName, 72 - (fontRenderer.getStringWidth(timeName)/2), 16, -1, true);
