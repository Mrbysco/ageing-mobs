package com.svennieke.AgeingMobs.compat.jei.regular;
...
public class RegularWrapper implements IRecipeWrapper{
	...
	public RegularWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime) {
		this.entity = entity;
