...
public class BiomeWrapper implements IRecipeWrapper{
	...
	public BiomeWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime, Biome biome) {
		this.entity = entity;
	...
	public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		 ...
		 if(originalEntity != null && agedEntity != null)
		 {
			 ...
			 String biomeName = "Biome: " + biome.getBiomeName();
			 fontRenderer.drawString(biomeName, 72 - (fontRenderer.getStringWidth(biomeName)/2), 16, -1, true);
