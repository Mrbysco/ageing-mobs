package com.shynieke.ageingmobs.compat.jei.magic;
...
public class MagicWrapper implements IRecipeWrapper{
	...
	public MagicWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime) {
		this.entity = entity;
