package com.shynieke.ageingmobs.compat.jei.boss;
...
public class BossWrapper implements IRecipeWrapper{
	...
	public BossWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime) {
		this.entity = entity;
