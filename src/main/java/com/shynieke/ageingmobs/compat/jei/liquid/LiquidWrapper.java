package com.shynieke.ageingmobs.compat.jei.liquid;
...
public class LiquidWrapper implements IRecipeWrapper{
	...
	public LiquidWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime, String liquid) {
		this.entity = entity;
