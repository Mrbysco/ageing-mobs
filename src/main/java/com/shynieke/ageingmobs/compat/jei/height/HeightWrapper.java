package com.shynieke.ageingmobs.compat.jei.height;
...
public class HeightWrapper implements IRecipeWrapper{
	...
	public HeightWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime, int minHeight, int maxHeight) {
		this.entity = entity;
	...
	public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		 ...
		 if(originalEntity != null && agedEntity != null)
		 {
			 ...
			 String heightName = "Y Level: " + minHeight + " to " + maxHeight;
			 fontRenderer.drawString(heightName, 72 - (fontRenderer.getStringWidth(heightName)/2), 16, -1, true);
