package com.shynieke.ageingmobs.compat.jei.dimension;
...
public class DimensionWrapper implements IRecipeWrapper{
	...
	public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		 ...
		 if(originalEntity != null && agedEntity != null)
		 {
			 ...
			 String dimensionIDName = "Dimension: " + String.valueOf(dimensionID);
			 fontRenderer.drawString(dimensionIDName, 72 - (fontRenderer.getStringWidth(dimensionIDName)/2), 16, -1, true);
