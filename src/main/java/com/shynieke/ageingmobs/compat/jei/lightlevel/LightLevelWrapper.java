...
public class LightLevelWrapper implements IRecipeWrapper{
	...
	public LightLevelWrapper(ItemStack egg1, ItemStack egg2, String entity, NBTTagCompound entityData, String transformedEntity, NBTTagCompound changedEntityData, int tickTime, int minLevel, int maxLevel) {
		this.entity = entity;
	...
	public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		 ...
		 if(originalEntity != null && agedEntity != null)
		 {
			 ...
			 String lightLevelName = "Light Levels: " + minLevel + " to " + maxLevel;
			 fontRenderer.drawString(lightLevelName, 72 - (fontRenderer.getStringWidth(lightLevelName)/2), 16, -1, true);
